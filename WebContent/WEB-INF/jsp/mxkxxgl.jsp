...
<div class="btn-group" style=" width:2%; height:10%;  float:left; margin-left:15%;">
  <button type="button" class="btn btn-warning">查询</button>
</div>
<div class="btn-group" style=" width:auto; height:auto;  float:left; margin-left:24%;">
  <button type="button" id="tjxsxx">添加学生信息</button>
</div>
...
<div class="col-lg-6"style="margin-top:50px;">
  ...
  <button type="button" id="queren" style="margin-top:100px; ">确认</button>
  <button type="button" id="quxiao" style="margin-top:100px;">取消</button>
  </div>
...
<div class="col-lg-6"style="margin-top:50px;">
  ...
  <input type="submit" value="添加" style="margin-top:100px; ">
  <button type="button" id="quxiao1" style="margin-top:100px;">取消</button>
