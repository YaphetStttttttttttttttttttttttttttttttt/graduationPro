...
<div  class="panel panel-primary">
  <div class="panel-heading" style="height:140px;">
    <h1 >成绩查询系统</h1>当前位置：管理员 >管理员信息管理<button type="button" class="btn btn-default btn-lg" style="float:right;">
  ...
  <div class="col-lg-6">
    <div class="input-group">
      <span class="input-group-btn">
        <button class="btn btn-default" type="button">账号  </button>
      </span>
...
<div class="col-lg-6">
  ...
  <button type="button" class="btn btn-primary" style="margin-top:50px; margin-left:600px;">保存</button>
  </div>
  </div>