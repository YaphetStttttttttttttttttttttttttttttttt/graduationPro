...
<div class="col-lg-6"style="margin-top:50px;">
  ...
  <button type="button" id="quxiao" style="margin-top:50px;" class="btn btn-warning">取消</button>
   ...
   <div id="heihei"  style="display:none;background-color:LightCyan;margin-top:50px;margin-left:140px;position:absolute;width:800px;">
...
<div class="form-group" id="thumbnailUploadContainer" class="col-sm-10" style="float: left; margin-left: 150px;margin-top: 35px;">
	通过excel表单添加：
